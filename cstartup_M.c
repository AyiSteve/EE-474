...
const intvec_elem __vector_table[] =
{
  ...
  0,
  Timer0A_Handler, //Interrupt for timer 0A
  0,
  Timer1A_Handler, // Interrupt for timer 1A
  0,
  0,
  0,
  0,
  ...
  0,
  0,
  GPIOJ_Handler, //Trigger a interrupt when ppressing the button on board
  0,
  GPIOL_Handler // Trigger a interrupt for port L
};
