...
#ifndef _Lab3_1bInits_H_
#define _Lab3_1bInits_H_
...
//Initalize onboard switch PJ  0 and PJ1
...
// generated whenever the A/D conversion is done. In addition it is set to the mood to read temperaature only
void ADCReadTemp_Init(void);

// Initializes Timer 0A to trigger ADC16 at 1 HZ.
void TimerADCTriger_Init(void);

#endif  // _Lab3_1bInits_H_
